  ...
  <div className="flex flex-col items-center w-full md:w-[300px] mx-auto">
          ...
          <div className="flex flex-col gap-2 items-center mb-4">
            <div className="flex items-center gap-2">
              <Mail size={18} />
              <a href='mailto:haque.eht@gmail.com'>haque.eht@gmail.com</a>
            </div>
            <div className="flex items-center gap-2">
              <Mail size={18} />
              <a href='mailto:ehtashamul.haque@bracu.ac.bd'>ehtashamul.haque@bracu.ac.bd</a>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <a
        ...
        <div>
          <h1 className="text-3xl font-bold mb-6 text-gray-900">Ehtashamul Haque</h1>
      ...
      <div className="border-t border-gray-200 pt-12">
        ...
        <div className="space-y-6">
          ...
          <div className="border-l-2 border-gray-300 pl-4">
            <p className="text-sm text-gray-500 mb-1">27 August 2025</p>
          ...
          <div className="border-l-2 border-gray-300 pl-4">
            <p className="text-sm text-gray-500 mb-1">3-7 August 2025</p>
            <p className="text-gray-700">
          ...
          <div className="border-l-2 border-gray-300 pl-4">
            <p className="text-sm text-gray-500 mb-1">15 May 2025</p>
            <p className="text-gray-700">
          ...
          <div className="border-l-2 border-gray-300 pl-4">
            <p className="text-sm text-gray-500 mb-1">29 July 2024</p>
            <p className="text-gray-700">
          ...
          <div className="border-l-2 border-gray-300 pl-4">
            <p className="text-sm text-gray-500 mb-1">28 May 2024</p>
            <p className="text-gray-700">
